...
export default function Home() {
  return (
    <>
      <section
        className="h-full w-full pt-36 relative flex flex-col items-center justify-center"
      >
      ...
      <section className="flex justify-center items-center flex-col gap-4 md:mt-20 mt-[-60px]">
        ...
        <div className="flex justify-center gap-4 flex-wrap mt-6">
          {pricingCards.map((card) => (
            <Card key={card.title} className={clsx('w-[300px] flex flex-col jusity-between', { 'border-2 border-primary': card.title === 'Unlimited Sass' })}>
              <CardHeader>
                <CardTitle
